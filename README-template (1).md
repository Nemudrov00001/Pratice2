...
Here we used:
So, the first Semantic
then, CSS custom properties and flexbox,Desktop-first workflow.

The dropdown menu is the highlight of my learning while working through this project. This is something I have never worked on before and had no prior knowledge how to go about it. I had to do a little research Stackover flow to the rescue. At the end, I was a able to complete the dropdown menu using just HTML and CSS- no JS.
...
Also, we added links to our portfolio page. As you can see it in the end. 

Here, only desktop version.
### Built with
